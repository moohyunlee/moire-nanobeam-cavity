...
*Independent computational investigation of phase-sensitive mode formation, numerical convergence, local leakage control, and quamtum-emitter placement in a three-row GaAs moiré nanobeam*

> **Main result**: At resolution 52, the unshifted M19 structure became spatially extended and yielded $Q\approx404$, invalidating the initial cavity interpretation.  Introducing a relative lattice shift in the moiré cell produced reproducible mirror-related localized modes with $Q\approx7.5\times10^3$, while local interface refinement further increased the 2D simulated $Q$ to approximately $9.6\times10^3$.
...
MPB was firste used to identify candidate TE-like folded bands and field symmetries in the periodic ABA supercell. The selected candidates were then transferred to finite M15-M19 structures and tested through FDTD optimization and numerical convergence.
...
<p align="center">
  <em>M19 moiré with offset adjustment</em>
</p>
...
<p align="center">
  <img src="figures/meep/offset_sign_comparison.png" width="1500">
</p>

<p align="center">
  <em>M19 moiré with offset adjustment</em>
</p>
In contrast, relative shifts of (+0.3a) and (-0.3a) produced mirror-related localized modes with nearly identical properties:
...
|Final non-contact|-0.3|+0.01a|9583|0.882|
...
A subsequent fixed-offset interface control showed that physical contact was not for the high-$Q$ localized response. A non-contact geometry with a (0.01a) gap reacehd $Q\approx9.6\times10^3, C_\mathrm{moire}\approx0.882$
...
<p align="center">
 ...
 <p align="center">
  <img src="figures/mpb/geometry.png" width="500">
</p>

<p align="center">
  <em>Initial Geometry without additional mirrors, and offset</em>
</p>
 Transfer candidate modes to Meep and test $Q$, localization, and numerical convergence.

 3. Phase and interface controls
  <p align="center">
  <img src="figures/meep/m19_geometry_final.png" width="500">
</p>

<p align="center">
  <em>M19 - Offset and mirror engineered geometry</em>
</p>
 Compare zero and opposite offsets, then vary one local interface hole at fixed offset to separate registry effects from contact and leakage effects.
